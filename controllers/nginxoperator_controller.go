...
import (
	...
	"github.com/mahmoudalide/nginx-operator/controllers/metrics"
...
//+kubebuilder:rbac:groups=operator.mahmoudalide.com,resources=nginxoperators,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.mahmoudalide.com,resources=nginxoperators/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.mahmoudalide.com,resources=nginxoperators/finalizers,verbs=update
